...
// 0xe3cb950cb164a31c66e32c320a800d477019dcff => fDAIx token address Super Token (upgrade/downgrade dai)
// 0x15F0Ca26781C3852f8166eD2ebce5D18265cceb7 fDAI normal token
contract BudgetNFT is ERC721, Ownable {
    ...
    AdPlaceNFT[] public details;

    // Create a function that takes fDAI from msg.sender
    // Function transfers tokens to smart contract ++
    // Smart contract upgrades selected amount with fDAIx  ++
    // Then issues NFT with certain flowRate ++
    ...
    function startStream(
        ...
        _dai.transferFrom(advertiser, address(this), daiAmount);
        _acceptedToken.upgrade(daiAmount);
        issueNFT(publisher, 100);
    }
